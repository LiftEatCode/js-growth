    ...
    <>
      ...
      <Section className="relative overflow-hidden bg-brand text-white">
        ...
        <Container className="relative">
          ...
          <p className="mt-10 max-w-2xl text-sm leading-7 text-slate-300">
            Looking for site-wide SEO foundations (not only Maps/GBP)? See{" "}
            <a href="/seo" className="text-cyan-300 underline-offset-2 hover:underline">
              SEO services
            </a>
            .
          </p>
