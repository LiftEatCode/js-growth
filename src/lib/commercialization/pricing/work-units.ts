...
export const WORK_UNIT_CATALOG: WorkUnitCatalogEntry[] = [
  ...
  {
    key: "scanability",
    title: "Improve content structure for scanability (headings, sections)",
    workType: "OPTIMIZATION",
    effortBand: "MEDIUM",
    actionKeys: ["scanability"],
    titleIncludes: ["scanability", "content structure for scanability"],
  },
  {
    key: "inline-css",
    ...
    workType: "TECHNICAL",
    effortBand: "MEDIUM",
    actionKeys: ["inline-css"],
    titleIncludes: ["excessive inline css", "inline css in the document"],
  },
  {
    key: "script-weight",
    title: "Reduce blocking script and third-party weight where evidenced",
    workType: "TECHNICAL",
    effortBand: "MEDIUM",
    actionKeys: ["script-weight"],
    titleIncludes: [
      "blocking script",
      "third-party weight",
      "third party weight",
  ...
  },
  {
    ...
    workType: "CONFIGURATION",
    effortBand: "MEDIUM",
    actionKeys: ["local-schema"],
    titleIncludes: ["localbusiness schema", "local business schema"],
  },
  {
    key: "nap",
    ...
    effortBand: "MEDIUM",
    actionKeys: ["nap"],
    titleIncludes: ["nap (name, address, phone)", "nap consistency"],
  },
  {
