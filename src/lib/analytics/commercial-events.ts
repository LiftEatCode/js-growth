...
const FORBIDDEN_ANALYTICS_PARAM_KEY_PATTERN =
  /report[_-]?id|session[_-]?id|payment[_-]?intent|customer[_-]?email|^email$|^url$|website_url|competitor[_-]?url|lead[_-]?id|contact[_-]?email|prospect[_-]?email|^to_email$/i;
