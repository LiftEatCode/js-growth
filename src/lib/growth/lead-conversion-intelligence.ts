...
export const TOUCH_SEMANTICS = {
  FIRST_OBSERVED: "LOCALSTORAGE_90D_TTL_ACQUISITION_CAPTURE_V1",
  CURRENT_SESSION: "SESSIONSTORAGE_TAB_ACQUISITION_CAPTURE_V1",
  LATEST_TOUCH: "NOT_MODELED_AS_GA4_LAST_CLICK",
  CROSS_DEVICE: "NOT_MODELED",
  SESSION_CAPTURE: "TAB_SESSION_FIRST_UTM_OR_REFERRER_OR_DIRECT",
} as const;
