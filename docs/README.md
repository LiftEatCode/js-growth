...
| Content Review V1 | [`growth/content-review.md`](growth/content-review.md) |
...
- [`growth/`](growth/) — Growth phase measurement, UTM, acquisition capture, follow-up operations, local/GBP intelligence, experiments, client talking points
- [`research/`](research/) — methodology research notes (e.g. measurement & attribution, acquisition capture, local/GBP)
